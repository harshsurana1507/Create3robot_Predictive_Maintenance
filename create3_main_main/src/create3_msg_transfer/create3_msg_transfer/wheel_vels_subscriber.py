...
def main(args=None):
    ...
    # when the garbage collector destroys the node object)
        ...
        if wheel_vels_subscriber:   # this if checks whether wheel_vels_subscriber exist or not
            wheel_vels_subscriber.destroy_node()   #function to destroy the node is called 
